...
(SHAP, LIME) для генерации человекочитаемых объяснений вида:

> "ИИ решил, что это вредоносная активность, потому что:
>  - размер пакета превышает норму на 40%
>  - порт источника нестандартный"
...
**Тема**: Разработка модуля для обнаружения аномалий в предсказаниях модели на этапе тестирования
